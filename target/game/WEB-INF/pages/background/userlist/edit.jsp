...
<body>
<form action="/userlist/index.action" method="post" class="definewidth m20">
    ...
    <tr>
        ...
        <td >
            <select name="userRole">
                <option value="admin" <c:if test="${user.userRole==admin}">selected="selected"</c:if>>管理员</option>
                <option value="user" <c:if test="${user.userRole==user}">selected="selected"</c:if>>用户</option>
            </select>
        </td>
    </tr>
